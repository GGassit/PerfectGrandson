...
// class AWeather_Override_Volume_C*       Param_Volume                                           (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void URandom_Weather_Variation_C::Get_State_for_Saving(struct FRandomWeatherVariation_State* State, class AWeather_Override_Volume_C** Param_Volume)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_Volume != nullptr)
		*Param_Volume = Parms.Param_Volume;
}
