...
public:
	...
	uint8                                         Pad_2046[0x10];                                    // 0x0038(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2047[0x138];                                   // 0x0028(0x0138)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class FName, struct FGameplayTagSource>  TagSources;                                        // 0x0160(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_2048[0x88];                                    // 0x01B0(0x0088)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2049[0x2];                                     // 0x004E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
