...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0642C8D0;
	constexpr int32 AppendString      = 0x01C0F8A0;
	constexpr int32 GNames            = 0x0638D200;
	constexpr int32 GWorld            = 0x06599188;
	constexpr int32 ProcessEvent      = 0x01D96FD0;
