...
// double                                  Param_Fog                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double                                  Param_Dust                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AUltra_Dynamic_Weather_C::Update_Weather_Settings_from_UDS(double Param_Cloud_Coverage, double Param_Fog, double Param_Dust)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Fog = Param_Fog;
	Parms.Param_Dust = Param_Dust;
...
void AUltra_Dynamic_Weather_C::Flash_Lightning(double Angle, bool Param_Use_Custom_Lightning_Location, const struct FVector& Param_Custom_Lightning_Location, const struct FVector& Custom_Target_Location)
{
	static class UFunction* Func = nullptr;
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// double                                  Param_Lightning                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void AUltra_Dynamic_Weather_C::Current_Lightning_Period_and_Status(double Param_Lightning, double* Period, bool* Enabled)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Lightning = Param_Lightning;
...
// double                                  Param_Dust_Depth                                       (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AUltra_Dynamic_Weather_C::Check_Point_for_Puddles_Snow_Or_Dust(const struct FVector& Location, const struct FVector& Ground_Normal, class UPhysicalMaterial* Physical_Material, double* Puddle_Depth, double* Param_Snow_Depth, double* Param_Dust_Depth)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_Dust_Depth != nullptr)
		*Param_Dust_Depth = Parms.Param_Dust_Depth;
}
...
// (Protected, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// class UUDS_Weather_Settings_C*          Param_Weather                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// double                                  Param_Dust                                             (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AUltra_Dynamic_Weather_C::Apply_Max_to_Material_Effects(class UUDS_Weather_Settings_C* Param_Weather, double* Snow_Coverage, double* Wetness, double* Param_Dust)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Weather = Param_Weather;
	...
	if (Param_Dust != nullptr)
		*Param_Dust = Parms.Param_Dust;
}
...
void AUltra_Dynamic_Weather_C::_Local_Weather()
{
	static class UFunction* Func = nullptr;
...
// Function Ultra_Dynamic_Weather.Ultra_Dynamic_Weather_C.Apply 5_1 Adjustment
// (Protected, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

bool AUltra_Dynamic_Weather_C::Apply_5_1_Adjustment()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_C", "Apply 5_1 Adjustment");

	Params::Ultra_Dynamic_Weather_C_Apply_5_1_Adjustment Parms{};
