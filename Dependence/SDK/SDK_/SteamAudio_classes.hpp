...
{
public:
	class FString                                 Name_SOFAFile;                                     // 0x0028(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(USOFAFile, Name_SOFAFile) == 0x000028, "Member 'USOFAFile::Name_SOFAFile' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_F3A[0x1];                                      // 0x002B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_F3B[0x1];                                      // 0x0037(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_F3C[0x4];                                      // 0x00A4(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	float                                         InfluenceRadius;                                   // 0x00A0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F3D[0x4];                                      // 0x00A4(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_F3E[0x10];                                     // 0x00C0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_F3F[0x3];                                      // 0x00C1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_F40[0x4];                                      // 0x00CC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	TSoftObjectPtr<class AActor>                  CurrentBakedListener;                              // 0x00A0(0x0030)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSimulateReverb;                                   // 0x00D0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EReverbSimulationType                         ReverbType;                                        // 0x00D1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F41[0x1E];                                     // 0x00D2(0x001E)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USteamAudioListenerComponent) == 0x0000F0, "Wrong size on USteamAudioListenerComponent");
...
static_assert(offsetof(USteamAudioListenerComponent, bSimulateReverb) == 0x0000D0, "Member 'USteamAudioListenerComponent::bSimulateReverb' has a wrong offset!");
static_assert(offsetof(USteamAudioListenerComponent, ReverbType) == 0x0000D1, "Member 'USteamAudioListenerComponent::ReverbType' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_F42[0x4];                                      // 0x0044(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_F43[0x28];                                     // 0x00B0(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	struct FSoftObjectPath                        Asset;                                             // 0x02C8(0x0020)(Edit, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EProbeGenerationType                          GenerationType;                                    // 0x02E8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F44[0x3];                                      // 0x02E9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         HorizontalSpacing;                                 // 0x02EC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         HeightAboveFloor;                                  // 0x02F0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumProbes;                                         // 0x02F4(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         DataSize;                                          // 0x02F8(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F45[0x4];                                      // 0x02FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FSteamAudioBakedDataInfo>       DetailedStats;                                     // 0x0300(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	class USteamAudioProbeComponent*              ProbeComponent;                                    // 0x0310(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F46[0x10];                                     // 0x0318(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ASteamAudioProbeVolume) == 0x000328, "Wrong size on ASteamAudioProbeVolume");
static_assert(offsetof(ASteamAudioProbeVolume, Asset) == 0x0002C8, "Member 'ASteamAudioProbeVolume::Asset' has a wrong offset!");
static_assert(offsetof(ASteamAudioProbeVolume, GenerationType) == 0x0002E8, "Member 'ASteamAudioProbeVolume::GenerationType' has a wrong offset!");
static_assert(offsetof(ASteamAudioProbeVolume, HorizontalSpacing) == 0x0002EC, "Member 'ASteamAudioProbeVolume::HorizontalSpacing' has a wrong offset!");
static_assert(offsetof(ASteamAudioProbeVolume, HeightAboveFloor) == 0x0002F0, "Member 'ASteamAudioProbeVolume::HeightAboveFloor' has a wrong offset!");
static_assert(offsetof(ASteamAudioProbeVolume, NumProbes) == 0x0002F4, "Member 'ASteamAudioProbeVolume::NumProbes' has a wrong offset!");
static_assert(offsetof(ASteamAudioProbeVolume, DataSize) == 0x0002F8, "Member 'ASteamAudioProbeVolume::DataSize' has a wrong offset!");
static_assert(offsetof(ASteamAudioProbeVolume, DetailedStats) == 0x000300, "Member 'ASteamAudioProbeVolume::DetailedStats' has a wrong offset!");
static_assert(offsetof(ASteamAudioProbeVolume, ProbeComponent) == 0x000310, "Member 'ASteamAudioProbeVolume::ProbeComponent' has a wrong offset!");
...
{
public:
	uint8                                         Pad_F47[0x2A];                                     // 0x0068(0x002A)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSteamAudioReverbSubmixPluginSettings  Settings;                                          // 0x0092(0x0002)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_F48[0x4];                                      // 0x0094(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_F49[0x2];                                      // 0x002A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_F4A[0x5];                                      // 0x002B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_F4B[0x3];                                      // 0x0091(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_F4C[0x2];                                      // 0x00B6(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_F4D[0x3];                                      // 0x010D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_F4E[0x3];                                      // 0x0119(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_F4F[0x4];                                      // 0x0134(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSoftObjectPath                        SOFAFile;                                          // 0x0138(0x0020)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USteamAudioSettings) == 0x000158, "Wrong size on USteamAudioSettings");
...
static_assert(offsetof(USteamAudioSettings, SOFAFile) == 0x000138, "Member 'USteamAudioSettings::SOFAFile' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_F50[0x2];                                      // 0x00A2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_F51[0x3];                                      // 0x00B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          bSimulateReflections;                              // 0x00C0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EReflectionSimulationType                     ReflectionsType;                                   // 0x00C1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F52[0x6];                                      // 0x00C2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class AActor>                  CurrentBakedSource;                                // 0x00C8(0x0030)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSimulatePathing;                                  // 0x00F8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F53[0x7];                                      // 0x00F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class ASteamAudioProbeVolume>  PathingProbeBatch;                                 // 0x0100(0x0030)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_F54[0x26];                                     // 0x0132(0x0026)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(USteamAudioSourceComponent, bSimulateReflections) == 0x0000C0, "Member 'USteamAudioSourceComponent::bSimulateReflections' has a wrong offset!");
static_assert(offsetof(USteamAudioSourceComponent, ReflectionsType) == 0x0000C1, "Member 'USteamAudioSourceComponent::ReflectionsType' has a wrong offset!");
...
static_assert(offsetof(USteamAudioSourceComponent, bSimulatePathing) == 0x0000F8, "Member 'USteamAudioSourceComponent::bSimulatePathing' has a wrong offset!");
static_assert(offsetof(USteamAudioSourceComponent, PathingProbeBatch) == 0x000100, "Member 'USteamAudioSourceComponent::PathingProbeBatch' has a wrong offset!");
...
{
public:
	struct FSoftObjectPath                        Asset;                                             // 0x0290(0x0020)(Edit, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F55[0x10];                                     // 0x02B0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ASteamAudioStaticMeshActor) == 0x0002C0, "Wrong size on ASteamAudioStaticMeshActor");
static_assert(offsetof(ASteamAudioStaticMeshActor, Asset) == 0x000290, "Member 'ASteamAudioStaticMeshActor::Asset' has a wrong offset!");
