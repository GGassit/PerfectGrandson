...
{
public:
	uint8                                         Pad_138F[0xC0];                                    // 0x0000(0x00C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_1390[0xC];                                     // 0x0000(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_1391[0x9];                                     // 0x0000(0x0009)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_1392[0xC8];                                    // 0x0000(0x00C8)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
